...
#jenkins创建任务的名称
work_name = 'XPON_SFU_MA5800_E_G_1'
...
#将变量写入初始配置文件中
#将变量写入初始配置文件中
file_initconfig_1 = os.path.join(dir_pc,'tests\\MA5800_E\\initialization_config.py')
with open(file_initconfig_1, "w",encoding='utf-8') as f:
    f.writelines(vars)

file_initconfig_2 = os.path.join(dir_pc,'tests\\MA5800_G\\initialization_config.py')

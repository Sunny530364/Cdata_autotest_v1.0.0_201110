...
#jenkins创建任务的名称
work_name = 'XPON_SFU_FD1216S_FD1616GS_1'
...
#将变量写入初始配置文件中
file_initconfig_1 = os.path.join(dir_pc,'tests\\FD1216S\\initialization_config.py')
with open(file_initconfig_1, "w",encoding='utf-8') as f:
    f.writelines(vars)

file_initconfig_2 = os.path.join(dir_pc,'tests\\FD1616GS\\initialization_config.py')

...
# dir_pc =os.path.abspath(os.path.dirname(os.path.dirname(os.path.dirname(__file__))))

#jenkins创建任务的名称
work_name = 'EPON_SFU_FD1216S_1'
...
#将变量写入初始配置文件
file_initconfig = os.path.join(dir_pc,'tests\\FD1216S\\initialization_config.py')
